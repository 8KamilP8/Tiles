...
namespace Utilities {
    ...
    public static class UtilFunc {
        ...
        /// <summary>
        /// Returns mouse position using Camera.main.ScreenToWorldPoint(Input.mousePosition);
        /// </summary>
        public static Vector3 GetMouseWorldPosition() {
            return Camera.main.ScreenToWorldPoint(Input.mousePosition);
        }
        /// <summary>
        /// Calculates and change rotation of given transform to look at target point in 2D space
        /// </summary>
        /// <param name="objToRotate"></param>
        ...
        /// <summary>
        /// Calculates and returns Quaternion which should be new rotation of given transform to look at target in 2D space.
        /// </summary>
        /// <param name="objRotationData"></param>
        /// <param name="target"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns random float with no need to pass values in correct order (a lower than b)
        /// </summary>
        /// <param name="a"></param>
        /// <param name="b"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns random normalized Vector2
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns angle between given Vector2 and OX.
        /// </summary>
        /// <param name="V"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns random Vector2 that is between A, B
        /// </summary>
        /// <param name="A"></param>
        /// <param name="B"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns random Vector2 that is between A, angle (clockwise)
        /// </summary>
        /// <param name="A"></param>
        /// <param name="B"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns random Vector2 with given length
        /// </summary>
        ...
        /// <summary>
        /// Returns random Vector2 point in given circle
        /// </summary>
        ...
        public static SpriteRenderer SpriteRendererPrefab {
            get {
                if (_spriteRendererPrefab == null) _spriteRendererPrefab = PrefabWithSpriteRenderer.GetComponent<SpriteRenderer>();
                return _spriteRendererPrefab;
            }
        }
        /// <summary>
        /// Empty static prefab with 
        /// </summary>
        public static GameObject PrefabWithSpriteRenderer {
            get {
                if (_prefab == null) _prefab = Resources.Load<GameObject>("prefab_with_sr");
                return _prefab;
            }
        }
    ...
    /// <summary>
    /// <para> MonoBehaviour with checking PauseManager flag </para>>
    /// <para> usage: derive from this class to create pause sensitive script. </para>
    /// <para> override methods OnUpdate, OnLateUpdate and OnFixedUpdate instead of using those methods without On prefix. </para>
    /// <para> When using those classes, there is need to set pause flag using Utilities.PauseManager </para>
    /// </summary>
    public class PauseMonoBehaviour : MonoBehaviour {
        /// <summary>
        /// Function called every frame, when PauseManager.Pause == false
        /// </summary>
        protected virtual void OnUpdate() {

        }
        /// <summary>
        /// Function called like LateUpdate, when PauseManager.Pause == false
        /// </summary>
        protected virtual void OnLateUpdate() {

        }
        /// <summary>
        /// Function called like FixedUpdate, when PauseManager.Pause == false
        /// </summary>
